 ...
 * 
 * @export
 * @interface ProjectsGetByProjectIdResponseDataRelationshipsTargetOneOf1DataAttributes
 */
export interface ProjectsGetByProjectIdResponseDataRelationshipsTargetOneOf1DataAttributes {
    /**
     ...
     * @type {string}
     * @memberof ProjectsGetByProjectIdResponseDataRelationshipsTargetOneOf1DataAttributes
     */
    'display_name'?: string;
    /**
