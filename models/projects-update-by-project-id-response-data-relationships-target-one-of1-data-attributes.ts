 ...
 * 
 * @export
 * @interface ProjectsUpdateByProjectIdResponseDataRelationshipsTargetOneOf1DataAttributes
 */
export interface ProjectsUpdateByProjectIdResponseDataRelationshipsTargetOneOf1DataAttributes {
    /**
     ...
     * @type {string}
     * @memberof ProjectsUpdateByProjectIdResponseDataRelationshipsTargetOneOf1DataAttributes
     */
    'display_name'?: string;
    /**
